...
iZone - ("i" も "l" や "o" 同様，視認性がよくないので採用しない） ex iOS zone ? (iOS は aZone/iOS ?)

lZone - ("l" は視認性がよくないので採用しない）

oZone - ("o" は視認性がよくないので採用しない） Office Zone ? (office は wZone/Office365 や gZone/GoogleDocs ?)

qZone - (小文字の "q" は "g" との誤認があるので "q" と "g" はどちらか一方にするのが安全)  -> gZone を採用して qZone は見送ることにした
